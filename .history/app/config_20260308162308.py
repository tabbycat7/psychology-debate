...
class Config:
    ...
    # 分镜生成模型（Gemini）—— 用于总结辩论并生成绘本分镜脚本
    STORYBOOK_SCRIPT_API_URL = os.environ.get('STORYBOOK_SCRIPT_API_URL', os.environ.get('ENHANCE_MODEL_API_URL'))
    STORYBOOK_SCRIPT_API_KEY = os.environ.get('STORYBOOK_SCRIPT_API_KEY', os.environ.get('ENHANCE_MODEL_API_KEY'))
    STORYBOOK_SCRIPT_MODEL = os.environ.get('STORYBOOK_SCRIPT_MODEL', 'gemini-2.5-pro')

    # 图片生成模型（豆包）—— 用于根据分镜生成绘本图片
    STORYBOOK_IMAGE_API_URL = os.environ.get('STORYBOOK_IMAGE_API_URL', 'https://ark.cn-beijing.volces.com/api/v3')
    STORYBOOK_IMAGE_API_KEY = os.environ.get('STORYBOOK_IMAGE_API_KEY', os.environ.get('ARK_API_KEY', ''))
    STORYBOOK_IMAGE_MODEL = os.environ.get('STORYBOOK_IMAGE_MODEL', 'doubao-seedream-5-0-260128')
